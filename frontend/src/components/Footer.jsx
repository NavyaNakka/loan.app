...
//             <div>
//               <p className="text-lg font-bold text-white">Ready to apply for your loan?</p>
//               <p className="mt-1 text-sm text-blue-100">
//                 Quick process. Transparent terms. Disbursed in days.
//               </p>
//             </div>
//             <Link
//               to="/apply-loan"
//               className="shrink-0 rounded-xl bg-white px-7 py-3 text-sm font-semibold text-blue-600 shadow-sm transition hover:bg-blue-50 active:scale-95"
//             >
//               Apply Now →
//             </Link>
//           </div>
...
//               <a href="tel:+911800000000" className="flex items-center gap-2.5 text-sm text-slate-400 transition hover:text-white">
